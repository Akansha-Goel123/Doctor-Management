...
public class EditPatient extends JFrame {
	...
	EditPatient()
	{
		...
		label=new JLabel("Update Patient Details");
		...
		label1=new JLabel("Patient_Name");
		...
		b1.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{
			       ...
			       String sql="update addpatient set Name='"+value1+"', Disease='"+value2+"',Password='"+value3+"',Email_ID='"+value4+"', Address='"+value5+"', Mobile_No='"+value6+"' where Patient_ID ='"+value+"'";
