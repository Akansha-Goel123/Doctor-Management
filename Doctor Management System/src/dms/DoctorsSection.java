...
public class DoctorsSection  extends JFrame{
    ...
    DoctorsSection(){
    	...
    	label=new JLabel("Doctor Section");
		...
		btnAdd=new JButton("Add New Doctor");
		...
		btnEdit=new JButton("Edit Doctor Record");
		...
		btnDelete=new JButton("Delete Doctor Record");
		...
		btnSearch=new JButton("Search Doctor Record");
    ...
    public static void main(String args[]){
    	...
    	DoctorsSection as=new DoctorsSection();
