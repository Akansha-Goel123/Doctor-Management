...
public class DoctorLogin extends JFrame{
	...
	DoctorLogin()
	{
		...
		label=new JLabel("Doctor Login Form");
		label.setBounds(150, 15, 450, 40);
		...
		label4= new JLabel();
		label4.setText("<html><h2 color=purple>If you are a new doctor, registered here:</h2></html>");
		...
		btnlogin.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(name.equals("admin")&& password.equals("admin123")){
					...
					JOptionPane.showMessageDialog(DoctorLogin.this, "Sorry, Username or password Error","Login Error",JOptionPane.ERROR_MESSAGE);
				}
